...
class _OrderState extends State<Order> {
  ...
  void initState() {
    ...
    myList = productProvider.ordersModelList;
    super.initState();
  }
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, myIndex) {
                      return CheckOutSingleProduct(
                        index: myIndex,
                        color: myList[myIndex].productColor,
                        size: myList[myIndex].productSize,
                        image: myList[myIndex].productImage,
                        name: myList[myIndex].productName,
                        price: myList[myIndex].productPrice,
                        quantity: myList[myIndex].productQuetity,
                      );
                    },
                  ),
                ),
